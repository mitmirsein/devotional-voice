...
- **🎙️ 대본 전용 생성 (New)**: 이미 작성된 노트에서 묵상글 생성 없이 **TTS 대본만 즉시 추출**할 수 있습니다.
- **🖱️ 우클릭 메뉴 지원 (New)**: 에디터에서 우클릭 한 번으로 음성 녹음, 텍스트 선택 묵상, TTS 대본 생성, 오디오 저장을 즉시 실행할 수 있습니다.
